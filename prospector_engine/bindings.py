...
BINDINGS: tuple[Binding, ...] = (
    ...
    Binding(IntentType.RESET_CHARACTER, _ctrl("r"), "Reset the character"),
    Binding(IntentType.PAN_SWAP_TEST, _ctrl("p"), "Pan swap service"),
    Binding(IntentType.DIG_LOOP, _ctrl("d"), "Dig service"),
    Binding(
