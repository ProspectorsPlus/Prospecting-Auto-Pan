...
RANGES = {
    ...
    "SHAKE_W_LEAD_MS": (0, 1200, 25), "SHARDS_DIG_CLICKS": (0, 8, 1),
    "SHARDS_CLICK_CONFIRM_MS": (40, 400, 10),
    "SHARDS_CLICK_RETRIES": (1, 6, 1),
    "DIG_PLATEAU_MS": (60, 400, 20), "DIG_SMART_CAP_MS": (300, 2000, 100),
    "LAND_ASSIST_MAX_MS": (100, 1500, 50), "DIG_PIPELINE_GAP_MS": (0, 2000, 25),
    "EARN_OCR_SEC": (3, 120, 1), "FINDS_OCR_MS": (120, 2000, 20),
    "FINDS_FAST_MS": (20, 200, 5), "FINDS_MIN_DWELL": (1, 10, 1),
    "FINDS_EMPTY_MS": (200, 3000, 50), "FINDS_CARD_SEC": (3, 15, 1),
    "FINDS_WHITE_MIN": (120, 230, 5),
    "FINDS_DARK_MAX": (50, 170, 5), "FINDS_BAND_MIN": (0.002, 0.05, 0.002),
    "SELL_BOOST_PCT": (100, 20000, 10), "FINDS_MIN_CONF": (0.0, 1.0, 0.05),
    "SR_TEXT_TOL": (10, 120, 5),
    "AUTOPAN_TOL": (10, 120, 5), "AUTOPAN_SETTLE_MS": (100, 2000, 50),
    "AUTOPAN_GUARD_SEC": (2, 60, 1), "AUTOPAN_STALL_SEC": (0, 60, 1),
    "AUTOPAN_RELOCK_DELAY_MS": (0, 1500, 25), "RELIC_LAND_MAX_S": (5, 120, 5),
    "SR_A_MAX_MS": (1000, 15000, 250), "SR_D_PCT": (10, 90, 5),
    "SR_S_MAX_MS": (500, 10000, 250),
    "SHAKE_START_CONFIRM_MS": (0, 1500, 50), "SHAKE_START_RETRIES": (0, 5, 1),
    "SHAKE_RETRY_DEEPER_MS": (20, 300, 10), "SHAKE_STALL_MS": (0, 3000, 100),
...
SYMPTOMS = [
    ...
    ("short_water", "Falls short of water",
     [("short of water", 5), ("doesn't reach the water", 4), ("not far enough back", 4),
      ...
      ("further into the water", 5), ("further into water", 5), ("deeper into the water", 5),
      ("further back into the water", 5), ("go deeper", 4), ("walk deeper", 4),
      ("more into the water", 4), ("walk further into", 4), ("further onto water", 5),
      ("walk further back", 3), ("need to go further back", 4)],
     [("shake", 1), ("land", 3), ("onto land", 4)], _fix_short_water),
    ("short_land", "Lands short / needs nudges",
     [("lands short", 5), ("short of land", 4), ("needs nudges", 4), ("too many nudges", 4),
      ...
      ("further onto land", 5), ("further onto the land", 5), ("further forward onto land", 5),
      ("more onto land", 4), ("walk further forward", 4), ("further up the land", 4),
      ("doesnt reach land", 4), ("need to go further onto land", 5)],
     [("water", 3), ("into water", 4), ("into the water", 4)], _fix_short_land),
