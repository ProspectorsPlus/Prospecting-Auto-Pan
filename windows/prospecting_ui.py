...
SECTIONS = [
    ...
    ("Smart / experimental", [
        ...
        ("FR_DOUBLE_GAP_MS","FR: gap between the two 4-presses (ms)",      "int", 120),
...
HELP = {
    ...
    "FR_DOUBLE_GAP_MS": "Gap between the two presses of slot 4 that double-tap to open Fast Travel. Lower it if a double-tap is not registering.",
